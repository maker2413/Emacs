...
*** Python Language Server
    ...
    Along with configuring a python language server I also like to setup and
    configure ~emacs-jupyter~ so that I can use jupyter notebooks when I am
    studying topics using python:
    #+begin_src emacs-lisp
      (use-package jupyter)
